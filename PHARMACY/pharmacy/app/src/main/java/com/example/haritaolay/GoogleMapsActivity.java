...
// kalıttığımız bütün sınıfları override etmemiz lazım fonksiyon olarak
   ...
   GetNearbyPlaces getNearbyPlaces=new GetNearbyPlaces();
        ...
        switch (v.getId()){
            ...
            case R.id.hospitals_nearby:
                mMap.clear();
                String url=getUrl(latitude,longitude,eczane);
                transferData[0]=mMap;
                transferData[1]=url;
...
googleURL.append("&radius=" + ProximityRadius);
    ...
    googleURL.append("&key=" + "AIzaSyC74awg8EYKLmbL8R7RXta_7pL890tUitA");
